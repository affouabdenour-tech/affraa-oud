        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="flex items-center gap-3 border-b border-border pb-4">
            ...
            <input
              ...
              placeholder={
                locale === 'ar'
                  ? 'ابحث عن عطر، علامة، أو عائلة عطرية...'
                  : 'Search fragrances, brands, families...'
              }
            ...
            <div className="mt-6 max-h-[60vh] overflow-y-auto">
              {results.length === 0 ? (
                ...
                <div className="space-y-2">
                  {results.map((product) => {
                    const searchPrice =
                      product.purchaseOptions?.fullBottle?.[0]?.price ??
                      product.purchaseOptions?.decants?.[0]?.price ??
                      product.price;
                    ...
                    return (
                      <Link
                        ...
                        onClick={() => setSearchOpen(false)}
                        className="flex items-center gap-4 rounded-xl border border-transparent p-3 transition-all duration-300 hover:border-gold/30 hover:bg-gold/10"
                      >
                        ...
                        <span className="font-display text-lg font-semibold text-gold">
                          {formatPrice(searchPrice, locale)}
                        </span>
                      </Link>
                    );
                  })}
